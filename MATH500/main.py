...
python main.py --method self-certainty --model_path Qwen/Qwen2.5-Math-7B-Instruct --temperature 0.7 --max_tokens 1024 --lambda_weight 0.5 --n_repetitive_sampling 8 --subset_size 100 
