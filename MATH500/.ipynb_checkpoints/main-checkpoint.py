...
python main.py --method self-certainty --model_path meta-llama/Llama-3.2-1B-Instruct --max_tokens 1024 --lambda_weight 0.5 --n_repetitive_sampling 8 --subset_size 100 
