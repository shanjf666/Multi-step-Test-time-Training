"""
CUDA_VISIBLE_DEVICES=1 python infer.py --model_path meta-llama/Llama-3.2-1B-Instruct --num_return_sequences 1
CUDA_VISIBLE_DEVICES=1 python infer.py --model_path Qwen/Qwen2.5-Math-1.5B
CUDA_VISIBLE_DEVICES=1 python infer.py --model_path Qwen/Qwen2.5-Math-1.5B-Instruct --num_return_sequences 1
CUDA_VISIBLE_DEVICES=1 python infer.py --model_path deepseek-ai/DeepSeek-R1-Distill-Qwen-1.5B
CUDA_VISIBLE_DEVICES=1 python infer.py --model_path /root/autodl-tmp/data/models/modelscope_cache/models/lijia321/ttrl_step_150_qwen_1.5B
"""
import argparse
import subprocess
import os
...
def run_pipeline(model_path, num_return_sequences=4, temperature=0.1, max_tokens=1024, alpha=0.4):
    ...
    # === 中间与最终文件路径 ===
    candidates_file = f"results/math500_candidates_{model_name}_{timestamp}.jsonl"
    scored_file = f"results/math500_best_{model_name}_{timestamp}.jsonl"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--max_tokens", type=int, default=2048, help="生成最大长度")
